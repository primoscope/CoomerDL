...
// Optimization: Only re-render if the download object has actually changed.
// Since we update the downloads array immutably in ProgressPanel,
// unchanged items will have referential equality.
